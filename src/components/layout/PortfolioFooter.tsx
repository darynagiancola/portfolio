    ...
    <footer id="contact" className="mt-4 border-t border-border/60 bg-secondary-soft/55 py-20">
      <div className="content-wrap">
        ...
        <p className="mt-5 max-w-[38rem] text-[1.08rem] leading-[1.55] text-[#4f5852]">
          I&apos;m interested in roles and projects involving AI implementation, automation, digital products and
          business systems, especially where understanding the business is as important as building the solution.
        </p>
        <a
